    ...
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 d-flex justify-content-end align-items-center">
        <a class="link-secondary" href="#" aria-label="Search">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="mx-3" role="img" viewBox="0 0 24 24"><title>Search</title></svg>
...
<main class="container">
  <div class="p-4 p-md-5 mb-4 text-white rounded bg-info">
    <div class="col-md-6 px-0">
      ...
      <p class="lead mb-0 "><a href="#" name="logout" class="text-dark fw-bold">Logout</a></p>
<?php
}else{
...
<script type="text/javascript">
 ...
 function runfunction(){
  $.post("htcon.php", {room:'<?php echo($room);?>'},
  ...
  //when entered key so form is submitted
...
input.addEventListener("keyup", function(event) {
  ...
  $("#btn").click(function(){
    var tin = $("#message").val();
     $.post("mesi.php",{mess : tin , room: '<?php echo $room; ?>',ip: '<?php echo $_SERVER['REMOTE_ADDER']     ?>'
  },
     function(data, status) {
      document.getElementsByClassName('container')[0].innerHTML=data;
